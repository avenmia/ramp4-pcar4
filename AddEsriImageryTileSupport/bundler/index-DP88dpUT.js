...
import { _ as H, d as L, F as K, G as X } from "./main-DXqEKCtO.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BVNxTr1h.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Bvcbw9wt.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DHmr-RQ5.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-zW8V5B7S.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-pjZGpDVG.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CP3v8Slo.js")))
      }), s;
    }), n = (s) => {
