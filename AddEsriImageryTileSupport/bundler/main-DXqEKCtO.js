      ...
      return M((v(), A("div", {
        ...
        s.header ? (v(), A("header", Ca, [
          ...
          m("div", {
            ...
            s.panel.teleport ? V("", !0) : (v(), A("div", Ma, [
              d.value ? (v(), W(F, {
                key: 0,
...
}), Da = { class: "relative" }, Ga = ["content", "aria-label"], Ua = ["transform"], Va = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Ba = { class: "relative" }, za = ["content", "aria-label"], qa = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
function Zo(s, e) {
  ...
  r.directive("focus-container", Sa), r.directive("focus-list", ba), r.directive("focus-item", Aa), r.directive("truncate", La), r.component("panel-screen", Fa), r.component("pin", Va), r.component("close", qa), r.component("back", Ha), r.component("expand", Xa), r.component("panel-options-menu", co), r.component("dropdown-menu", ii), r.component("minimize", to), r.component("right", ro), r.component("left", no), r.component("fullscreen-nav-button", ho), r.component("geolocator-nav-button", fo), r.component("home-nav-button", mo), r.component("mapnav-button", vo), r.component("appbar-button", Eo), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || He.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class jn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = He.geom, this.proj = He.proj, this.shared = He.sharedUtils, this.map = new tn(e), this.layer = new yn(e), this.attributes = new Fn(e), this.query = new qn(e), this.symbology = new zn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Wn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-TxvoK1mK.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Ds0rlsp6.js"), "../fixtures/basemap/index.ts": () => import("./index-NJ5mYWTe.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DN2_nclk.js"), "../fixtures/details/index.ts": () => import("./index-CupEvYQo.js"), "../fixtures/draw/index.ts": () => import("./index-CymJw7Im.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BBXsGKt5.js"), "../fixtures/export-legend/index.ts": () => import("./index-ksvs2EsW.js"), "../fixtures/export-map/index.ts": () => import("./index-Dyky00-X.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Cc4T6_MX.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CGQLljgQ.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-hs_xiJxy.js"), "../fixtures/export-title/index.ts": () => import("./index-Db23MODa.js"), "../fixtures/export/index.ts": () => import("./index-DBuc7dXA.js"), "../fixtures/extentguard/index.ts": () => import("./index-C55Gz5aa.js"), "../fixtures/gazebo/index.ts": () => import("./index-DKJ0rVOi.js"), "../fixtures/geosearch/index.ts": () => import("./index-ATfZi-JM.js"), "../fixtures/grid/index.ts": () => import("./index-CuaeZRUb.js"), "../fixtures/help/index.ts": () => import("./index-CVD7Xs45.js"), "../fixtures/hilight/index.ts": () => import("./index-DOAMKsyU.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DG1gLG5X.js"), "../fixtures/legend/index.ts": () => import("./index-mEdlDWqr.js"), "../fixtures/mapnav/index.ts": () => import("./index-DP88dpUT.js"), "../fixtures/metadata/index.ts": () => import("./index-3W22I1mc.js"), "../fixtures/northarrow/index.ts": () => import("./index-HtK60d20.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BDUbQIY8.js"), "../fixtures/panguard/index.ts": () => import("./index-BGbFcWvQ.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CHXUSx-T.js"), "../fixtures/settings/index.ts": () => import("./index-CW_qX7sd.js"), "../fixtures/snowman/index.ts": () => import("./index-UjKa1Hrx.js"), "../fixtures/swipe/index.ts": () => import("./index-Bf6omdw3.js"), "../fixtures/wizard/index.ts": () => import("./index-BbMMuSq-.js") });
class Hn extends J {
  /**
...
const Xn = /* @__PURE__ */ Ne(Kn, [["render", Zn], ["__scopeId", "data-v-a3c61802"]]), Qn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BC0VCniY.js"), "../fixtures/basemap/screen.vue": () => import("./screen-h7mEgdcb.js"), "../fixtures/export/screen.vue": () => import("./screen-Dswdu2q1.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CKUnXnYC.js"), "../fixtures/grid/screen.vue": () => import("./screen-DnTA9jb0.js"), "../fixtures/help/screen.vue": () => import("./screen-BR_G03Ig.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-D338j4Ah.js"), "../fixtures/legend/screen.vue": () => import("./screen-BRWQsnf_.js"), "../fixtures/metadata/screen.vue": () => import("./screen-Byn2pDo8.js"), "../fixtures/settings/screen.vue": () => import("./screen-BTay846z.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BqWMJicF.js") });
class St extends J {
  /**
   * ID of this panel.
   *
...
var at = { major: "4", minor: "14", patch: "0-beta", timestamp: "Fri Sep 19 13:00:39 2025 -0500", hash: "e6fd1a5870917e32b743c0bef3531f870d3c7a24" };
console.info(
...
const Yl = (s, e, t) => new Ko(s, e, t), He = new zs();
export {
  H as $,
  Gr as A,
  yt as B,
